...
class Ejercicio01Kotlin {
    ...
    fun main(){
        ...
        val cadena4="world" // declaramos la cadena de "worl"
    ...
    private fun sonAnagramas(
        ...
        // lo convertimos en una lista de caracteres y la ordenamos
        val cadena2LowerCase=cadena2.lowercase().toList().sorted() // convertimos la primera cadena a minúsculas,
        // lo convertimos en una lista de caracteres y la ordenamos
        // retornamos true si ambas listas de caracteres ordenadas son iguales
